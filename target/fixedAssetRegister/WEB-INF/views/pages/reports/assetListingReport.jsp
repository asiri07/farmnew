        ...
        <div class="page">
            <form name=""
                ...
                <div class="row" style="margin: 0">
                    <legend>Assets Listing By Value</legend>
                </div>
                            ...
                            <div class="col-md-7">
                                <div class='input-group date'>
                                    ...
                                    <span class="input-group-addon">
                                        <span style="font-size:24px;color:#3e71fb; width: 60px" class="fa fa-calendar"></span>
                                                </span>
                                </div>
                            </div>
                ...
                <div class="row" style="padding-top: 10px">
                    ...
                    <div class="col-md-8">
                        <div class="row">
                            ...
                            <div class="col-md-3" >
                                <a type="button" class="btn btn-primary" style="width: 100%;height: 30px; font-size: 14px; margin-top: 2px" href="${root}/report/assetListing">New</a>
                            </div>
                            <div class="col-md-3" >

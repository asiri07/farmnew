...
@Entity
@Table(name = "maintenance_vehicle_history")
public class MaintenanceVehicleHistory implements Serializable {

    @Id
    @GeneratedValue(strategy=GenerationType.AUTO)
    @Column(name = "VEHICLE_HISTORY_ID")
    ...
    public int getVehicleHistoryID() {
        return vehicleHistoryID;
    }

    public void setVehicleHistoryID(int vehicleHistoryID) {

...
@Entity
@Table(name = "maintenance_office_equipment_history")
public class MaintenanceOfficeEquipmentHistory implements Serializable {

    @Id
    @GeneratedValue(strategy = GenerationType.AUTO)
    private int id;

    @Column(name = "OFFICE_EQUIPMENTS_ID")
    private int officeEquipmentsId;
    ...
    public int getOfficeEquipmentsId() {
        return officeEquipmentsId;
    }

    public void setOfficeEquipmentsId(int officeEquipmentsId) {
        this.officeEquipmentsId = officeEquipmentsId;
    }
